...
# https://github.com/apache/airflow/blob/2.2.3/airflow/providers/amazon/aws/hooks/glue_crawler.py
# glue crawler delete 를 추가 구현 하기 위해 custom 하게 구성
...
class AwsGlueCrawlerHook(AwsBaseHook):
    ...
    def delete_crawler(self, crawler_name: str) -> dict:
        """
        Delete crawler configurations

        :param crawler_name: unique crawler name per AWS account
        :type crawler_name: str
        :return: Nested dictionary of {}
        """
        return self.glue_client.delete_crawler(Name=crawler_name)
